...
public static class SeedData
{
    public static async Task InitializeAsync(IServiceProvider serviceProvider)
    {
        ...
        {
            new() { Name = "Tech Summit 2026", Description = "Annual technology conference featuring cutting-edge talks, workshops, and networking opportunities for developers and tech enthusiasts.", Date = now.AddDays(10), Time = new TimeSpan(9, 0, 0), EventType = "Conference", MaxCapacity = 300 },
            new() { Name = "Community Wellness Day", Description = "A day dedicated to health, mindfulness, and community well-being. Join us for yoga, wellness workshops, and healthy food demonstrations.", Date = now.AddDays(5), Time = new TimeSpan(8, 0, 0), EventType = "Wellness", MaxCapacity = 150 },
            new() { Name = "Art & Culture Festival", Description = "Celebrate local art and culture with exhibitions, live performances, and interactive workshops. Open to all ages!", Date = now.AddDays(15), Time = new TimeSpan(10, 0, 0), EventType = "Festival", MaxCapacity = 500 },
            new() { Name = "Hackathon Spring 2026", Description = "48-hour coding marathon open to all skill levels. Build innovative solutions for real community problems.", Date = now.AddDays(20), Time = new TimeSpan(8, 0, 0), EventType = "Competition", MaxCapacity = 200 },
            new() { Name = "Networking Mixer", Description = "Monthly professionals networking event. Connect, collaborate, and grow your network in a relaxed environment.", Date = now.AddDays(3), Time = new TimeSpan(18, 0, 0), EventType = "Networking", MaxCapacity = 100 },
            new() { Name = "Photography Walk", Description = "Explore the city through a lens! Join professional photographers on a guided photo walk through iconic spots.", Date = now.AddDays(7), Time = new TimeSpan(7, 30, 0), EventType = "Tour", MaxCapacity = 30 }
        };
